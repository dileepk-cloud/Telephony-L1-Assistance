    ...
    <div className="bg-white border rounded-lg shadow-sm font-sans text-sm relative h-[800px] overflow-hidden flex flex-col">
      ...
      <div className="flex justify-between items-center p-4 border-b">
        <div className="flex items-center space-x-2">
          <span className="font-bold text-gray-800 tracking-wide text-lg">Telecmi</span>
        </div>
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="custom" readOnly />
                <div className="w-1/2 border rounded-md p-2 bg-white text-gray-700 flex justify-between items-center cursor-not-allowed">
                  <span>Lead ID</span>
                  <span className="text-gray-400">▼</span>
                </div>
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="secret" readOnly />
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800" value={secret} readOnly />
                <button className="text-blue-500 bg-blue-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg></button>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-center">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                ...
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="application/json" readOnly />
                <button className="text-blue-500 bg-blue-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg></button>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-6 pb-8">
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                ...
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="Call initiated" readOnly />
                <button className="text-blue-500 bg-blue-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg></button>
              </div>
            </div>
