...
interface SmartpingConfigViewProps {
  configData?: any;
  agentNumber?: string;
}

export default function SmartpingConfigView({ configData, agentNumber }: SmartpingConfigViewProps) {
    ...
    <div className="bg-white border rounded-lg shadow-sm font-sans text-sm relative h-[800px] overflow-hidden flex flex-col">
      ...
      <div className="flex justify-between items-center p-4 border-b">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-bold text-gray-800 tracking-wide text-lg">Smartping</span>
        </div>
        ...
        {activeTab === 'inbound' && <InboundConfigTab />}
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex items-center mt-2">
              ...
              <div className="flex-1 flex border rounded-md overflow-hidden bg-gray-50 w-48">
                <button className="px-4 py-1.5 border-r text-gray-600 flex-1">Get</button>
                <button className="px-4 py-1.5 bg-blue-500 text-white font-medium flex-1 shadow-inner">Post</button>
              </div>
            </div>
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1">
                <input type="text" className="w-full border rounded-md p-2 bg-gray-50 text-gray-800" value={configData?.url || "https://ccs1.smartpingcc.io/v2/clickToCall/para"} readOnly />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex items-center mt-2">
              ...
              <div className="flex-1 flex space-x-4">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="from" readOnly />
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="to" readOnly />
                <div className="w-1/2 border rounded-md p-2 bg-white text-gray-700 flex justify-between items-center cursor-not-allowed">
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="cust_Uniq_ID" readOnly />
                <div className="w-1/2 border rounded-md p-2 bg-white text-gray-700 flex justify-between items-center cursor-not-allowed">
                  <span>Lead ID</span>
                  <span className="text-gray-400">▼</span>
                </div>
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1 flex space-x-4 items-center">
                ...
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800 font-mono truncate" value={configData?.userId || "24119920"} readOnly />
              </div>
            </div>
            ...
            <div className="flex items-center mt-4">
              <div className="w-1/3"></div>
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="token" readOnly />
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800 font-mono truncate" value={configData?.token || "8nTBWvEeloCCpPBOC8zB"} readOnly />
                <button className="text-red-500 bg-red-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4"></path></svg></button>
              </div>
            </div>
            ...
            <div className="flex items-center mt-4">
              <div className="w-1/3"></div>
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="fromType" readOnly />
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800" value="Agent" readOnly />
                <button className="text-red-500 bg-red-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4"></path></svg></button>
              </div>
            </div>
            ...
            <div className="flex items-center mt-4">
              <div className="w-1/3"></div>
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="fromStrategy" readOnly />
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800" value="ONE_BY_ONE" readOnly />
                <button className="text-red-500 bg-red-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4"></path></svg></button>
              </div>
            </div>
            ...
            <div className="flex items-center mt-4">
              <div className="w-1/3"></div>
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="toType" readOnly />
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800" value="Number" readOnly />
                <button className="text-red-500 bg-red-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4"></path></svg></button>
              </div>
            </div>
            ...
            <div className="flex items-center mt-4">
              <div className="w-1/3"></div>
              <div className="flex-1 flex space-x-4 items-center">
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white" value="toStrategy" readOnly />
                <input type="text" className="w-1/2 border rounded-md p-2 bg-white text-gray-800" value="ONE_BY_ONE" readOnly />
                <div className="flex space-x-2">
                  <button className="text-red-500 bg-red-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4"></path></svg></button>
                  <button className="text-blue-500 bg-blue-50 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg></button>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-200/60 text-gray-700">
                  ...
                  <th className="p-3 border-b font-medium w-1/3">Agent ID</th>
                </tr>
              </thead>
              <tbody>
                {/* Demo Row */}
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-3">
                    <input type="text" className="w-full bg-gray-50 border-0 rounded px-3 py-1.5 text-gray-600 outline-none" value={agentNumber || "24615"} readOnly />
                  </td>
                </tr>
              </tbody>
            </table>
