...
export default function SmartpingSparcConfigView({ authorization, agentNumber, displayNumber }: SmartpingSparcConfigViewProps) {
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="flex-1">
                <input type="text" className="w-full border rounded-md p-2 bg-gray-50 text-gray-800" value="https://ccs.sparc.smartping.io/crm-integration/api/v1/phoneBridge/clickToCall" readOnly />
              </div>
            </div>
          </div>
